...
pub struct Server {
    ...
    /// public key (value). The lookup is `HGET <table> <kid>`.
    ...
    #[cfg_attr(
        ...
        arg(
            long,
            value_name = "TABLE",
            env = "WSTUNNEL_JWT_REDIS_KEYS_TABLE",
            verbatim_doc_comment
        )
    )]
    pub jwt_redis_keys_table: Option<String>,
    ...
    #[cfg_attr(
        ...
        arg(
            ...
            value_name = "SECONDS",
            default_value = "10",
            env = "WSTUNNEL_JWT_REDIS_CONNECT_TIMEOUT_SEC",
            verbatim_doc_comment
        )
    )]
    pub jwt_redis_connect_timeout_sec: u64,
    ...
    #[cfg_attr(
        ...
        arg(
            ...
            value_name = "SECONDS",
            default_value = "10",
            env = "WSTUNNEL_JWT_REDIS_RESPONSE_TIMEOUT_SEC",
            verbatim_doc_comment
        )
    )]
    pub jwt_redis_response_timeout_sec: u64,
